  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: TextField(
        ...
        await prefs.setString('email', email.text); //reomve in future
        await prefs.setString('token', response['token']);
          popPush(context, HomeScreen());
            ...
            showToastAlert(context,response["msg"]);
                        ...
                        child:  Center(
                          child:  loading ? loader(context) : const Text("Login", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                        ),
                      )),
                        const SizedBox(height: 20,),
                      FadeInUp(
